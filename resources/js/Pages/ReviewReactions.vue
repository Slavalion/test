...
import { reviewReactionSlide } from '@/modals'
...
import ReviewReactionSlide from '@/Modals/ReviewReactionSlide.vue'
...
<template>
    <Head>
        <title>Реакции на отзывы</title>
    </Head>

    <AuthenticatedLayout>
        <template #header>Реакции на отзывы</template>
        ...
        <div v-if="reviewReactions.length" class="panel panel_product">
            <AppTable>
                <template #head>
                    <tr>
                        <TableTh class="text-left">Товар</TableTh>
                        <TableTh class="text-left">Артикул</TableTh>
                        <TableTh class="text-left">Лайки/Дизлайки</TableTh>
                        <TableTh class="text-left"></TableTh>
                    </tr>
                </template>

                <tr v-for="review in reviewReactions" :key="review.id" class="main-table__tr">
                    <td>
                        ...
                        <template v-if="true">
                            <div>
                                ...
                                <div class="flex gap-1 flex-wrap leading-none text-gray-300">
                                    <span
                                        v-for="item in review.review_reactions"
                                        :key="item.task_id"
                                    >
                                        {{ item.task_id }},
                                    </span>
